  ...
  return (
    <div className="flex flex-col justify-center bg-black h-[350px] text-white mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        ...
        <div>
          <h1 className=" font-medium text-3xl pb-4 pt-5 md:pt-0">Links</h1>
        ...
        <div>
          <h1 className=" font-medium text-3xl pb-4 pt-5 md:pt-0">Menu</h1>
          <nav className=" flex flex-col gap-2">
            <a
              className=" hover:text-brightColor transition-all cursor-pointer"
              href="/"
        ...
        <div>
          <h1 className=" font-medium text-3xl pb-4 pt-5 md:pt-0">Contact Us</h1>
          <nav className=" flex flex-col gap-2">
            <a
              className=" hover:text-brightColor transition-all cursor-pointer"
              href="/"
